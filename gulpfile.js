...
module.exports = (context) => {
    ...
    const docFolder = context.docFolder; // path.join(__dirname, 'docs');
    ...
    gulp.task('dev', () => {
        ...
        const webpackConfig = require('./webpack.config')(srcFolder, buildFolder, docFolder);
    ...
    gulpsequence([context.currentEnv], () => {});
