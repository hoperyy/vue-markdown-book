...
function processer(context) {
    ...
    const createPage = (currentFolder) => {
        ...
        const docNameInfo = dirInfoUtil.getDocInfo(globalDocFolder, path.join(globalDocFolder, docName));
    ...
    const devHandler = () => {
        ...
        gulpWatch([path.join(globalDocFolder, '**/*')], (stats) => {
            ...
            let docNameInfo = dirInfoUtil.getDocInfo(globalDocFolder, path.join(globalDocFolder, docName));
            ...
            switch(stats.event) {
                ...
                case 'add':
                    ...
                    if (checkUtil.checkShouldNotShow(globalDocFolder, filePath)) {
                        ...
                        docMap[docName] = dirInfoUtil.getDocInfo(globalDocFolder, path.join(globalDocFolder, docName));
